...
public class Vehicle {
    ...
    /**
     * GeoJSON LineString of the real road route from dispatch point to emergency.
     * Fetched from OSRM on dispatch, stored here so it travels with the vehicle
     * payload over WebSocket — frontend draws it instantly without extra calls.
     */
    ...
    public void setAssignedEmergencyId(Long id) { this.assignedEmergencyId = id; }
    ...
    public void setVehicleStatus(String s) { this.vehicleStatus = s; }
